...
impl IntoResponse for AuthError {
    fn into_response(self) -> Response {
        match self {
            ...
            AuthError::OidcStateMismatch => Redirect::to("/v1/auth/oidc-start").into_response(),

            AuthError::OidcTokenExchange => Redirect::to("/v1/auth/oidc-start").into_response(),

            AuthError::OidcNoIdToken => Redirect::to("/v1/auth/oidc-start").into_response(),

            AuthError::OidcTokenInvalid => Redirect::to("/v1/auth/oidc-start").into_response(),
        }
    }
}
