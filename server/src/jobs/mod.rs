...
impl<'a> ProgramQuery<'a> {
    ...
    pub fn resolve_fields(&self, expr_id: ExprId) -> Vec<pipeline_types::Field> {
    ...
    pub fn lookup_fields_by_def(&self, def_id: DefId) -> Vec<pipeline_types::Field> {
    ...
    pub fn lookup_fields(&self, name: Symbol) -> Vec<pipeline_types::Field> {
        let def = self
            .program
            .gcx
            .definitions
