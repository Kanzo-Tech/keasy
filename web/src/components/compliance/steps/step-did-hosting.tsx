...
export function StepDidHosting({ onComplete, completed, wizardState }: StepDidHostingProps) {
  ...
  const isAutoGenerated = !!services?.base_domain && !!domain;
  ...
  async function handleFile(file: File) {
    ...
    try {
      ...
      const msg = err instanceof ApiError ? err.message : "Certificate validation failed";
      setError(msg);
          ...
          <CardContent className="pt-4 pb-4">
            ...
            {isAutoGenerated && (
              <p className="text-xs text-muted-foreground mt-1">
                This domain is automatically assigned based on your organization&apos;s subdomain.
              </p>
            )}
          </CardContent>
        </Card>
